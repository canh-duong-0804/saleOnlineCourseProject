                ...
                <section class="content">
                    <div class="d-flex form-inputs">
                        <form action="searchcourse" method="POST">
                            <input type="text" name="search" ><!-- comment -->
...
<%
    String id = request.getParameter("id");
                %>
                    <div class="card">
                        <form action="addcoursetoprocess" method="GET" >
                            <div class="card-header">
                                <h3 class="card-title">Course</h3>
                                <input type="text" name="id" value="<%=id%>" hidden>
                                <div class="card-tools">
                                    <a class="btn btn-danger btn-sm" >
                                        <span><input type="submit" value="Add" style="color: white;background-color: #dc3545;
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item "><a class="page-link " ${tag == 1?"hidden":""} href="${way}?index=${tag - 1}&option=${option}&search=${search}&id=<%= id %>">Previous</a></li>
                            <c:forEach begin ="1" var="i" end = "${endPage}">
                            <li class="page-item"><a class="page-link " ${tag == i?"active":""} href="${way}?index=${i}&option=${option}&search=${search}&id=<%= id %>"   >${i}</a></li>
                            </c:forEach>
                        <li class="page-item "><a class="page-link " ${tag == endPage?"hidden":""} href="${way}?index=${tag + 1}&option=${option}&search=${search}&id=<%= id %>">Next</a></li>
                    </ul>
                </nav>
