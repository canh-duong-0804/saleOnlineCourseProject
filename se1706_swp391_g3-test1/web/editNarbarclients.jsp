                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form id="quickForm" action="editnarbaradmins?id=${blog.getNewsID()}" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                        
                                           <br>
                                            <label for="exampleInputEmail1">Name</label>
                                            <input type="text" name="namenarbar" class="form-control" value="${blog.getNewsTitle()}" id="exampleInputEmail1" placeholder="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Url</label>
                                            <input type="text" name="urlnarbar" value="${blog.getNews()}" class="form-control" id="exampleInputPassword1" placeholder="">
                                        </div>
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <button type="reset" onclick="history.back()" class="btn btn-default"><i class="fas fa-times"></i> Discard</button>
                                            </div>
