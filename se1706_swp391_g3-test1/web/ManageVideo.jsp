        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action="searchCourseVideo" method="POST">
                        <input style="width: 20%" class="form-control"  type="text" name="search" ><!-- comment -->
                        <select style="width: 20%" class="custom-select mr-sm-2 " id="option" name="option">
                                    ...
                                    <c:forEach items="${data}" var="item">
                                        <tr>
                                            ...
                                            <td class="project-actions">
                                                <a class="btn btn-dark btn-sm"  href="viewVideo?id=${item.getCourseID()}" title="view">
                                                    <i class="fas fa-eye">
                                                    </i>
                                                </a>
                                            </td>
