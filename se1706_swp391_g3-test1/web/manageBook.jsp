...
<html lang="en">   
    ...
    <body class="hold-transition sidebar-mini layout-fixed" data-panel-auto-height-mode="height">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <form action="searchbook" method="get">
                                    <div class="col-md-12">
                                        <div class="input-group"><input type="text" placeholder="Search Here" class="input-sm form-control"name="search"> <span class="input-group-btn">
                                                <input type="submit" class="input-sm form-control " value="Search">  </span></div>
                                    </div>
                                </form>
                                <form action="filterbookadmin" method="get">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="filter"></form>
                            </div>
                ...
                <!-- Main content -->
                <form id="myForm" action="deletebookselect" method="get">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="postcoursebook" class="btn btn-success"><i
                                    ...
                                    <c:forEach items="${data}" var="item">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td >
                                                    <span class="custom-checkbox">
                                                        <input type="checkbox" id="checkbox1" name="options" value="${item.getCourse_BookID()}">
                                                ...
                                                <td class="project-actions text-right">
                                                    <a class="btn btn-primary btn-sm" href="viewclientbookdetails/Sach-lap-trinh${showBlogDetails.convertToSlug(item.getBookName().replaceAll(" ","-"))}-${item.getCourse_BookID()}">
                                                        <i class="fas fa-folder">
                                                        </i>

                                                    </a>
                                                    <a class="btn btn-info btn-sm" href="editbook?id=${item.getCourse_BookID()}">
                                                        <i class="fas fa-pencil-alt">
                                                        </i>

                                                    </a>

                                                    <a class="btn btn-danger btn-sm" data-toggle="modal" href="#" onclick="confirmDelete('${item.getCourse_BookID()}')" >
    ...
    <script>
        function confirmDelete(itemId) {
            ...
            deleteItemLink.href = 'deletebooks?id=' + itemId;
