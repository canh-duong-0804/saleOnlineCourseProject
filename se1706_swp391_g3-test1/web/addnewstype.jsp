          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add news types</h3>
              </div>
              <!-- /.card-header -->
              
              
              <!-- form start -->
              <form id="quickForm" action="addnewstype" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">type news</label>
                    <input type="text" name="typenewsname" class="form-control" id="exampleInputEmail1" placeholder="">
                  </div>
