                    ...
                    <div class="card-body">
                        ...
                        <form action="verify" method="get" >
                            ...
                            <div class="input-group">
                                <input class="input--style-3" type="text"  value="${data}" readonly placeholder="Username" name="username">
                            </div>
                            <div class="input-group">
                                <input class="input--style-3" type="password"  required placeholder="Password" name="password">
                            </div>
                            <div class="input-group">
