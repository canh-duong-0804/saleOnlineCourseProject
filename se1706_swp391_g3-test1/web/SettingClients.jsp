        ...
        <div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" action="settingClients" method="POST">
                        <div class="card-body">
                            <div class="form-group">

                                <br>
                                <label for="exampleInputEmail1">Address</label>
                                <input type="text" name="address" class="form-control" value="${blog.getNewsTitle()}" id="exampleInputEmail1" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Phone Number</label>
                                <input type="text" name="phone" value="${blog.getNews()}" class="form-control" id="exampleInputPassword1" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Email</label>
                                <input type="text" name="email" value="${blog.getNewsImg()}" class="form-control" id="exampleInputPassword1" placeholder="">
                            </div>
