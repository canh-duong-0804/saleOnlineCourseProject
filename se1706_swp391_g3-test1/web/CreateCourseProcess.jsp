            ...
            <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
                <div class="wrapper wrapper--w780">
                    <div class="card card-3">
                        ...
                        <div class="card-body">
                            <h2 class="title">Create Course Process</h2>
                            <form action="createProcess" method="Post" enctype="multipart/form-data">
                                <div class="input-group">
                                    ProcessName<input class="input--style-3" type="text" placeholder="${s}" name="name" required>
                                </div>
                                <div class="input-group">
                                    Image<input class="input--style-3" type="file" placeholder="${s}" name="image" accept="image/*" required>
                                </div>
                                <div class="p-t-10">
