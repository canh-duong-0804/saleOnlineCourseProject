                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Quick Link</h3>
                                </div>
                                <!-- /.card-header -->


                                <!-- form start -->
                                <form id="quickForm" action="editquicklink?id=${blog.getNewsID()}" method="POST">
                                     <div class="card-header">
                            <input type="text" readonly value="${NewsID}" name="id">
                        </div>
                                    <div class="card-body">
