...
<%@page  import="Model.CourseProcess" %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
            <div class="wrapper wrapper--w780">
                <div class="card card-3">
                    ...
                    <div class="card-body">
                        <h2 class="title">Update Process</h2>
                        
                        <form action="updateprocess" method="post" enctype="multipart/form-data">
                            <div class="input-group">
                                <input class="input--style-3" type="text"  name="id" value="${pc.getId()}" readonly>
                            </div>
                            <div class="input-group">
                                <input class="input--style-3" type="text"  name="name" value="${pc.getName()}" required>
                            </div>
                             <div class="input-group">
                                <input type="file" name="image" id="name" class="input--style-3" placeholder="Image" value="${pc.getImage()}" accept="image/*">
                            </div>
