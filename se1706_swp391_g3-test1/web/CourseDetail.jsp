                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="coursecontroller">Home</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="col-12">
                                        <img src="${"./img/"}${cs.getCourseImg()}" class="product-image" alt="Product Image" style="width: 50%;">
                                    </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="mt-4">
                                        <div class="btn btn-primary btn-lg btn-flat">
                                            <i class="fas fa-tv fa-lg mr-2"></i>
                                            ${size} Video
                                        </div>
                                    </div>
