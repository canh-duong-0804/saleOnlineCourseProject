                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form id="quickForm" action="showlistnarbar" method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                        
                                           <br>
                                            <label for="exampleInputEmail1">Name</label>
                                            <input type="text" name="namenarbar" class="form-control" value="" id="exampleInputEmail1" placeholder=""required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Url</label>
                                            <input type="text" name="urlnarbar" value="" class="form-control" id="exampleInputPassword1" placeholder=""required>
                                        </div>
