...
<!--                <div class="col-12 pb-1">
                            ...
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action" style="
                                        ...
                                        <a href="cart?courseID=${p.getCourseID()}" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0; font-size:120%;">Join Now</a>
                                    </div>
                                </div>
                                <div class="text-center py-4">
                                    <c:set var="detailid" value="${p.getCourseID()}" />
                                    <a style="font-size:160%;" class="h6 text-decoration-none text-truncate" href="productdetail?detailid=${p.getCourseID()}">${p.getCourseName()}</a>
                                ...
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    <h8 style="font-size:150%;" class="fa fa-user text-primary me-2"> ${p.getAdminID()}</h8>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <li class="page-item "><a class="page-link " ${tag == 1?"hidden":""}  href="Category?id=${id}&&username=${username}&&index=${tag - 1}">Previous</a></li>
                            <c:forEach begin ="1" var="i" end = "${endPage}">    
                            <li class="page-item"><a class="page-link ${tag == i?"active":""}" href="Category?id=${id}&&username=${username}&&index=${i}">${i}</a></li>
                            </c:forEach>
                        <li class="page-item "><a class="page-link " ${tag == endPage?"hidden":""} href="Category?id=${id}&&username=${username}&&index=${tag + 1}">Next</a></li>
                    </ul>
                </nav>  
            </div>
        </div>
