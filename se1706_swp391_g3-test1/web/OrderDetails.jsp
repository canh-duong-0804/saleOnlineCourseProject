                        ...
                        <div class="card-body p-0">
                            <table class="table table-borderless">
                                            ...
                                            <td>
                                                <div class="d-flex mb-2">
                                                    <div class="flex-lg-grow-1 ms-3">
                                                        <h6 class="small mb-0"><a href="#" class="text-reset">${item.getCourseName()}</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>1</td>
                                            <td class="text-end">${item.getCoursePrice()}</td>
                                        </tr>
                                    ...
                                    <c:forEach items="${requestScope.dataBook}" var="item"> 
                                        <tr>
                                            <td>
                                                <div class="d-flex mb-2">
                                                    <div class="flex-lg-grow-1 ms-3">
                                                        <h6 class="small mb-0"><a href="#" class="text-reset"> ${item.getBookName()}</a></h6>
                                                    </div>
                                                </div>
                                            </td>
                                ...
                                <tfoot>
                                    ...
                                    <tr class="fw-bold">
                                        <td>
                                            Export to : <form method="post" action="export?mode=excel" target="_blank"  style="display:inline-block;text-align: center">
                                                <input style="display:none" type="text" readonly name="orderID" value="${orderID}">
