                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <div class="navbar-nav ms-auto p-4 p-lg-0">
                                ...
                                <a href="purchasedCourse" class="nav-item nav-link">Own Course</a>
        <%  
...
//                            
//                            if (logged){
//                                out.print("<a href=\"profile?username="+username+"\" class=\"nav-item nav-link\">"+username+"</a>");
//                            }
//                            else{
//                                out.print("<a href='Login.jsp' class='btn btn-primary py-4 px-lg-5 d-none d-lg-block'>Login Now<i class='fa fa-arrow-right ms-3'></i></a>");
//                            }
        %>
    </div>
</div>
            ...
            <div class="col-md-9 ">
                <div class="row pb-3">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item "><a class="page-link ${tag == 1?"hidden":""}" href="comboCourse?id=${id}&&index=${tag - 1}">Previous</a></li>
                                <c:forEach begin ="1" var="i" end = "${endPage}">    
                                <li class="page-item"><a class="page-link ${tag == i?"active":""}" href="comboCourse?id=${id}&&index=${i}">${i}</a></li>
                                </c:forEach>

                            <li class="page-item "><a class="page-link ${tag == endPage?"hidden":""}"  href="comboCourse?id=${id}&&index=${tag + 1}">Next</a></li>
                        </ul>
                    </nav>
