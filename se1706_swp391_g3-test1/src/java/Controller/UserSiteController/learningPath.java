...
public class learningPath extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<CourseProcess> c = dao.ProcessCourse(index);
        int count = dao.getTotalProcessCourse();
        int endPage = count / 6;
        if (count % 6 != 0) {
            endPage++;
        }
        request.setAttribute("link", "learningPath");
