 ...
 * @author admin
 */
public class editNarbarClients extends HttpServlet{
...
NewsDAO update = new NewsDAO();
        update.updateNarbarClients(id,NewsTitle,News);
...
NewsDAO edit = new NewsDAO();
       News blog= edit.getNarbarClients(id);
               
               
       req.setAttribute("blog", blog);
       req.setAttribute("NewsID", id);
       
        req.getRequestDispatcher("editNarbarclients.jsp").forward(req, resp);
